...
function Proposal() {
    return (
     <>                         
                                 ...
                                 <div className="Rant_title d-flex  justify-content-start  " style={{marginLeft:"12px"}}>
                                 <nav aria-label="breadcrumb">
  <ol class="breadcrumb Proposal_title">
    <li class="breadcrumb-item text_darkblue ">Search Result </li>
    <li class="breadcrumb-item active text_bluegreen" aria-current="page">rant</li>
  </ol>
</nav>
          </div> 
           <div className="Rant">
                   ...
                   <div className="Rant_card_div">
                       ...
                       <div className="Rcard_contentLast_row">
                            <div><p className="Rtext_size_responsive"><span className="card_icon_space">
                                <FavoriteOutlinedIcon  className="Ricon_size_responsive"  style={{color:"lightgray"}}  />&nbsp;</span>1.5K</p></div>
                            <div><p className="Rtext_size_responsive"> <ChatBubbleIcon className="Ricon_size_responsive"  style={{color:"lightgray"}} />&nbsp;800 Comments</p></div>
